...
const processText = (text) => {
    let processedText = text.replace(/<style.*?<\/style>/gs, '')
        ...
        .replace(/<div class="lib">/g, `<div class="color-container container-flex blue-container">${containerIconStars}`)
        .replace(/<div class="important-2">/g, `<div class="color-container container-flex blue-container">${containerIconStars}`)
        ...
        .replace(/<\/div>/, '')
        .replace(/<figure class="img"><img class="img-bg" src="\/asset-v1:SkillFactory\+MIFIIB\+2022_DEC\+type@asset\+block@star-fill\.svg" width="24" height="24"><\/figure>/, '');
